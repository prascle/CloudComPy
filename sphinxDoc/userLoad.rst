...
(see `here <https://gitlab.com/openfields1/CloudComPy/-/blob/master/doc/UseLinuxCondaBinary.md#execute-all-the-python-tests>`_ for Linux
or `there <https://gitlab.com/openfields1/CloudComPy/-/blob/master/doc/UseWindowsCondaBinary.md#execute-all-the-python-tests>`_ for Windows
`or there <https://gitlab.com/openfields1/CloudComPy/-/blob/master/doc/UseMacOSCondaBinary.md#execute-all-the-python-tests>`_ for macOs.
