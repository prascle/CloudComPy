...
void export_colors(py::module &m0)
{
    ...
    py::class_<QRgba64>(m0, "QRgba64", Rgba64Py_QRgba64_doc)
        .def(py::init<>(), Rgba64Py_QRgba64_ctor_doc)
    ...
    py::class_<QColor>(m0, "QColor", colorsPy_QColor_doc)
        .def(py::init<>(), colorsPy_QColor_ctor0_doc)
        .def(py::init<int, int, int, int>(), colorsPy_QColor_ctor1_doc)
        .def(py::init<unsigned int>(), colorsPy_QColor_ctor2_doc)
        .def(py::init<QRgba64>(), colorsPy_QColor_ctor3_doc)
        .def(py::init<const QString&>(), colorsPy_QColor_ctor4_doc)
